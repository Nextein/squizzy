...
const accountData = [
  { user: "Kai", email: "kailashsuredaquintana", browser: "Kai Phone", assets: 250, open: -1, liquidation: -1, api: "", sec: "", task: "" },
  ...
  { user: "Quico", email: "quicosureda", browser: "MacM Firefox & Aurora Edge", assets: 256, open: -1, liquidation: -1, api: "", sec: "", task: "" },
  ...
  { user: "Maryu", email: "mgf.4992", browser: "Aurora Opera", assets: -1, open: -1, liquidation: -1, api: "", sec: "", task: "??" },
  { user: "Pana", email: "ppsymmetry", browser: "Aurora Avast", assets: 45, open: -1, liquidation: -1, api: "", sec: "", task: "" },
  { user: "Diego", email: "diegocampos76", browser: "Aurora Firefox", assets: 256, open: -1, liquidation: -1, api: "", sec: "", task: "" },
  ...
  { user: "Marc Ribas", email: "marcribasm", browser: "AlienB Avast", assets: -1, open: -1, liquidation: -1, api: "", sec: "", task: "code" },
  { user: "Nancy", email: "nancysureda74", browser: "AlienB Chrome", assets: -1, open: -1, liquidation: -1, api: "", sec: "", task: "code" },
  ...
  { user: "Pep", email: "pepseguimendez", browser: "Alien Avast", assets: -1, open: -1, liquidation: -1, api: "", sec: "", task: "code" },
  { user: "Rayito", email: "theekko", browser: "Aurora Brave", assets: 203, open: -1, liquidation: -1, api: "", sec: "", task: "" },
  { user: "Maria Andrea", email: "mqcryptofund", browser: "Alien Brave", assets: 125, open: -1, liquidation: -1, api: "", sec: "", task: "" },
  { user: "Maria Flor", email: "mafloren", browser: "Alien Chrome", assets: 117, open: -1, liquidation: -1, api: "", sec: "", task: "" },
  { user: "Julieta", email: "ophisto.ilv", browser: "MacR Firefox", assets: 365, open: -1, liquidation: -1, api: "", sec: "", task: "" },
  { user: "Quico Pujol", email: "quicoso72", browser: "MacR Brave", assets: 254, open: -1, liquidation: -1, api: "", sec: "", task: "" },
  { user: "Cristina Pujol", email: "titanorsito", browser: "MacR Opera", assets: 463, open: -1, liquidation: -1, api: "", sec: "", task: "" },
  { user: "Gargufo", email: "chucopabras", browser: "MacR Safari", assets: 42, open: -1, liquidation: -1, api: "", sec: "", task: "" },
  { user: "Joan", email: "joandlfuente", browser: "MacR Avast", assets: 557, open: -1, liquidation: -1, api: "", sec: "", task: "" },
